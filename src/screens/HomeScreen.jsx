...
const SKIP_SUBJECTS = ["Morning Focus Time", "Rise & Shine", "Afternoon Occupations", "Lunch", "Outdoor Break", "Afternoon Pursuits", "House Reset & Animal Chores", "Tuesday Rhythm", "Tennis"];

// ─── BEAUTY BLOCK (school year only) ───────────────────────────────────
...
// ─── FAMILY BIBLE STUDY CARD (school year only) ────────────────────────
    ...
    <div className={`screen${isSummer ? " summer" : ""}`}>
      ...
      {isSummer ? (
        ...
        <>
          ...
          {/* HABIT FOCUS (term habit — also rendered in summer view) */}
