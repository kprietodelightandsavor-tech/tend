        ...
        <div style={{ marginBottom: 12, paddingBottom: 12, borderBottom: "1px solid var(--rule)" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 6 }}>
            <div style={{ display: "flex", alignItems: "baseline", gap: 8 }}>
              ...
              <div>
                <p style={{ fontFamily: "'Lato', sans-serif", fontSize: 9, letterSpacing: ".14em", textTransform: "uppercase", color: "var(--sage)", marginBottom: 1 }}>
                  Nature Loop · {step.step}
                </p>
                <p style={{ fontFamily: "'Playfair Display', serif", fontSize: 15, color: "var(--ink)" }}>{step.label}</p>
              </div>
            </div>
            <button onClick={markDone}
              style={{ background: "var(--sage-bg)", border: "1px solid var(--sage-md)", borderRadius: 2, padding: "5px 10px", cursor: "pointer", fontSize: 9, fontFamily: "'Lato', sans-serif", letterSpacing: ".1em", textTransform: "uppercase", color: "var(--sage)", flexShrink: 0 }}>
              Done ✦
            </button>
          </div>
