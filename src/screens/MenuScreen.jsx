  ...
  return (
    <div className="screen">
      ...
      <div style={{ marginTop: 8 }}>
        ...
        {/* Books & Curriculum row */}
        <div className="chapter-row" onClick={() => onNavigate("books")}>
          <div style={{ display: "flex", alignItems: "baseline", gap: 16 }}>
            <span className="chapter-num" style={{ fontStyle: "normal", fontSize: 11 }}>✦</span>
            <div>
              <p className="chapter-title">Books & Curriculum</p>
              <p className="chapter-sub">The living feast — your year in books</p>
            </div>
          </div>
          <span className="chapter-arrow">→</span>
        </div>
        ...
        {/* Annual Report row */}
        <div className="chapter-row" onClick={() => onNavigate("annualreport")}>
          <div style={{ display: "flex", alignItems: "baseline", gap: 16 }}>
            <span className="chapter-num" style={{ fontStyle: "normal", fontSize: 11 }}>✦</span>
            <div>
              <p className="chapter-title">Annual Report</p>
              <p className="chapter-sub">CM transcript & sufficiency evaluation</p>
            </div>
          </div>
          <span className="chapter-arrow">→</span>
        </div>
        ...
        {/* Teaching Record row */}
        <div className="chapter-row" onClick={() => onNavigate("teachinglog")}>
          <div style={{ display: "flex", alignItems: "baseline", gap: 16 }}>
            <span className="chapter-num" style={{ fontStyle: "normal", fontSize: 11 }}>✦</span>
            <div>
              <p className="chapter-title">Teaching Record</p>
              <p className="chapter-sub">What we taught, week by week</p>
            </div>
          </div>
          <span className="chapter-arrow">→</span>
        </div>
