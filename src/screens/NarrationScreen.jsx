...
const SUBJECTS = [
  ...
  { id: "history",     label: "History",           emoji: "🏛️", color: "#C49A4E" },
  { id: "bible",       label: "Bible",             emoji: "✝️", color: "#9B8EC4" },
  { id: "nature",      label: "Nature Study",      emoji: "🌿", color: "#93A388" },
  ...
  if (view === "coach") return (
    <div className="screen">
      ...
      <div style={{ display: "flex", gap: 8, marginBottom: 20 }}>
        <span style={{ fontFamily: "'Lato', sans-serif", fontSize: 9, letterSpacing: ".12em", textTransform: "uppercase", color: subjectObj?.color || "var(--sage)", background: `${subjectObj?.color || "#93A388"}15`, border: `1px solid ${subjectObj?.color || "var(--sage-md)"}40`, borderRadius: 20, padding: "3px 10px" }}>
      ...
      {!showFollowUp ? (
        ...
        <div style={{ background: "#F7F3EC", border: "1px solid var(--rule)", borderRadius: 3, padding: "16px 18px", marginBottom: 12 }}>
      ...
      {isLastPrompt && (
        <div style={{ background: "var(--gold-bg)", border: "1px solid #EFE7D6", borderRadius: 3, padding: "18px 20px", marginBottom: 20 }}>
