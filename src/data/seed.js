...
export const DAY_SCHEDULE = {
  ...
  Tuesday: [
    ...
    { id: "t-3",  subject: "Beauty Loop OR Volunteer",    time: "10:00", note: "Citizenship & Self-Growth — or Cibolo Rehab Center on volunteer Tuesdays" },
    { id: "t-4",  subject: "Living Literature",           time: "9:15",  note: "Read-aloud — Read Aloud Revival or A Gentle Feast list" },
    { id: "t-5",  subject: "Language Arts & Math",        time: "10:30", note: "First subject rotation" },
  ...
  Wednesday: [
    ...
    { id: "w-3",  subject: "Beauty Loop",                 time: "9:30",  note: "Recitation, Biography, Folk Song" },
    { id: "w-4",  subject: "Living Literature",           time: "9:15",  note: "Read-aloud — Read Aloud Revival or A Gentle Feast list" },
    { id: "w-5",  subject: "Language Arts & Math",        time: "10:30", note: "First subject rotation" },
    { id: "w-6",  subject: "Nature Study",                time: "11:45", note: "Outdoor observation — sketch & narrate" },
    { id: "w-7",  subject: "Lunch",                       time: "12:30", note: "", free: true },
    { id: "w-8",  subject: "History Spine",               time: "1:00",  note: "Story of the World or current history spine" },
    { id: "w-9",  subject: "Math — Independent Study",    time: "1:45",  note: "Independent work for students not in math lesson" },
  ],
  Thursday: [
  ...
  Friday: [
    ...
    { id: "f-3",  subject: "Beauty Loop",                 time: "9:30",  note: "Composer Study & Hymn Study" },
    { id: "f-4",  subject: "Living Literature",           time: "9:15",  note: "Read-aloud — Read Aloud Revival or A Gentle Feast list" },
    { id: "f-5",  subject: "Language Arts & Math",        time: "10:30", note: "First subject rotation" },
    { id: "f-6",  subject: "Nature Study",                time: "11:45", note: "Outdoor observation — sketch & narrate" },
    { id: "f-7",  subject: "Lunch",                       time: "12:30", note: "", free: true },
    { id: "f-8",  subject: "Geography",                   time: "1:00",  note: "Draw the World — current unit" },
